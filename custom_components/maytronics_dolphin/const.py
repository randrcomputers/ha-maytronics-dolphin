...
RESPONSIVE_ACTIVE_POLL_SEC = 12
RESPONSIVE_IDLE_POLL_SEC = 60
RESPONSIVE_ACTIVE_FULL_POLL_EVERY = 1
RESPONSIVE_IDLE_FULL_POLL_EVERY = 5
...
POWER_CONFIRM_ATTEMPTS = 8
POWER_CONFIRM_DELAY_SEC = 0.85
POWER_CONFIRM_INITIAL_DELAY_SEC = 0.6
